...
import { contentService as serverContentService, type Content, type UploadCallbacks } from './contentService';
...
export const fileService = {
  async getFileContent(url: string, fileId?: string): Promise<Blob> {
      // Temporarily disable offline functionality to fix build
      const isOnline = true; // typeof navigator !== 'undefined' ? navigator.onLine : true;
