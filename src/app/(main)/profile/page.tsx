...
import { Camera, Edit, Loader2, Save, User as UserIcon } from 'lucide-react';
...
export default function ProfilePage() {
  const { user, isSuperAdmin, isSubAdmin, setUser } = useAuthStore();
        ...
        {editingName ? (
          <div className="flex items-center gap-2">
            <Input
              ...
              className="text-3xl font-bold text-center h-auto bg-transparent border-b-2 border-slate-600 focus-visible:ring-0 focus:border-blue-400"
              autoFocus
            />
            <Button size="icon" onClick={handleSaveName} disabled={isSavingName} className="h-9 w-9">
